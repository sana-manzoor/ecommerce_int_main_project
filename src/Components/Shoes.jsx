...
import { addwishs, category } from '../services/allApis'
...
function Shoes() {
  ...
  return (
    <>
            ...
            <h1 className='text-center m-5'>Shoes</h1>
                            ...
                            <Card.Img variant="top" src={`${BASE_URL}/upload/${item.product_image}`} style={{ height: '230px' }} className='img-fluid m-2' onClick={()=>{storep(item._id)}} />
                              <Card.Body>
                                ...
                                <div className="card-footer d-flex justify-content-between">
                                  <Button className="btn " variant="outline-dark" onClick={()=>{addwishlist(item)}}   ><i className="fa-solid fa-lg fa-heart-circle-plus" ></i></Button>
